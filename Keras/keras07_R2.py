...
model.fit(x_train, y_train, epochs=500, batch_size=5) # fit == 트레이닝 100번 훈련 1,2,3,4,5를 한개씩(1) 잘라서 훈련
...
loss, mse = model.evaluate(x_test, y_test, batch_size=5) # evaluate함수에 x_test, y_test값을 넣으면 loss a[0], acc a[1] 값이 나온다.
print("mse : ", mse) # 1.0 
...
# R2의 값을 늘렸더니 R2 0.9999999999992074 , RMSE의 값은 낮아졌다. RMSE 3.846355047163435e-06