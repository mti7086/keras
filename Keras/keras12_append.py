...
x1x2 = Dense(5, activation='relu')(input1) # dense1 layer/ input: 1, ouput:5
x1x2 = Dense(3)(x1x2) # dense2 layer/ input: 5, ouput:3
x1x2 = Dense(4)(x1x2) # dense3 layer/ input: 3, ouput:4
x1x2 = Dense(6)(x1x2)
x1x2 = Dense(3)(x1x2)
x1x2 = Dense(7)(x1x2)
x1x2 = Dense(2)(x1x2)
...
model.fit(x1x2_train,y1y2_train, epochs=100, batch_size=1,
...
y1_predict = model.predict(x1x2_test)
print(y1_predict)
...
r2_y1_predict = r2_score(y1y2_test, y1_predict)
