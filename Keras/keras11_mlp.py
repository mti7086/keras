...
x = np.array([range(1, 101), range(101, 201)]) # 2개의 calum 2개의 열/ 100행 2열
y = np.array([range(1, 101), range(101, 201)]) # 2개의 calum 2개의 열/ 100행 2열
# print(x)
...
model.add(Dense(5, input_shape=(2, ), activation='relu')) # input_shape=2 열 2개를 받아서 Dense(5,) 5개를 출력
model.add(Dense(3))
model.add(Dense(4))
